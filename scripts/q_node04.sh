...
th train1.lua -hidden_size 10000 > ~/deepbio/logs/4_deepbio_$(date +%Y_%m_%d_%H_%M_%S) &
sleep 1
th train1.lua -hidden_size 50000 > ~/deepbio/logs/4_deepbio_$(date +%Y_%m_%d_%H_%M_%S) &
sleep 1
th train1.lua -learning_rate 0.001 > ~/deepbio/logs/4_deepbio_$(date +%Y_%m_%d_%H_%M_%S) &
